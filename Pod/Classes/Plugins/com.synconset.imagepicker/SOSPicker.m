...
- (void)getPictures:(CDVInvokedUrlCommand *)command {
	...
	ELCAlbumPickerController *albumController = [ELCAlbumPickerController new];
...
- (void)elcImagePickerController:(ELCImagePickerController *)picker didFinishPickingMediaWithInfo:(NSArray *)info {
    ...
    NSString* docsPath = [[NSTemporaryDirectory()stringByStandardizingPath] stringByAppendingPathComponent:folder];
    NSError* err = nil;
