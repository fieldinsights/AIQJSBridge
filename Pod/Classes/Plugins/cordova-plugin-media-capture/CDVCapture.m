...
- (CDVPluginResult*)processImage:(UIImage*)image type:(NSString*)mimeType forCallbackId:(NSString*)callbackId
{
    ...
    NSString* docsPath = [[NSTemporaryDirectory()stringByAppendingPathComponent:folder]stringByStandardizingPath];   // use file system temporary directory
    NSError* err = nil;
...
- (void)loadView
{
    ...
    // make backgrounds
    NSString* microphoneResource = @"AIQJSBridge.bundle/CDVCapture.bundle/microphone";
    ...
    if (isIphone5) {
        microphoneResource = @"AIQJSBridge.bundle/CDVCapture.bundle/microphone-568h";
    }
    ...
    // add bottom bar view
    UIImage* grayBkg = [UIImage imageNamed:[self resolveImageResource:@"AIQJSBridge.bundle/CDVCapture.bundle/controls_bg"]];
    ...
    UIImage* recordingBkg = [UIImage imageNamed:[self resolveImageResource:@"AIQJSBridge.bundle/CDVCapture.bundle/recording_bg"]];
    ...
    self.recordImage = [UIImage imageNamed:[self resolveImageResource:@"AIQJSBridge.bundle/CDVCapture.bundle/record_button"]];
    self.stopRecordImage = [UIImage imageNamed:[self resolveImageResource:@"AIQJSBridge.bundle/CDVCapture.bundle/stop_button"]];
